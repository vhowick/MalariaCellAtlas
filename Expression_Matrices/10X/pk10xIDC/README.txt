pk10xIDC: 4237 P. knowlesi cells that passed QC (>150 genes per cell).
...
clock_pseudotime: pseudotime calculated from pk PCA using clock method
PC1 and PC2 PCA coordinates of pk used to calculate clock pseudotime and shown in fig 3

bulk: highest cor with Lapp et al