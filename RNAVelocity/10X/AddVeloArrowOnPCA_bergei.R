...
plot(current_pca[,1], current_pca[,2], pch=16, col=remap_colors(dat_10X$ann$cell_color))
...
png("Bergei_SuperPCAWithArrows.png", width=4, height=4, units="in", res=300)
#pdf("Bergei_SuperPCAWithArrows.pdf", width=4, height=4)
par(mar=c(1,1,1,1))
plot(current_pca, pch=21, bg=remap_colors(dat_10X$ann$cell_color), col=remap_colors(dat_10X$ann$cell_color), cex=1, xaxt="n", yaxt="n")
box(lwd=2)
