...
count_mat <- readMM("/lustre/scratch117/cellgen/team218/TA/Malaria_RNAVelocity/10XOutput/cellranger210_count_24612_4472STDY7230041_3D7_Jan16v3-ensembl_37_transcriptome/raw_gene_bc_matrices/3D7_Jan16v3/matrix.mtx");
...
g <- read.table("/lustre/scratch117/cellgen/team218/TA/Malaria_RNAVelocity/10XOutput/cellranger210_count_24612_4472STDY7230041_3D7_Jan16v3-ensembl_37_transcriptome/raw_gene_bc_matrices/3D7_Jan16v3/genes.tsv")
...
c <- read.table("/lustre/scratch117/cellgen/team218/TA/Malaria_RNAVelocity/10XOutput/cellranger210_count_24612_4472STDY7230041_3D7_Jan16v3-ensembl_37_transcriptome/raw_gene_bc_matrices/3D7_Jan16v3/barcodes.tsv")
c <- sub("-1", "", c[,1])
g <- g[,1]
...
#plotPCA(mca_pb_tmm, exprs_values = "norm_exprs", ntop = 1000)
...
#png("Falciparum_SuperPCAWithArrows.png", width=4, height=4, units="in", res=300)
pdf("new_Falciparum_SuperPCAWithArrows.pdf", width=4, height=4)
par(mar=c(1,1,1,1))
